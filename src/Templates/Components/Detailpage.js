          ...
          <div className="row px-xl-5">
            <div className="col">
              <div className="owl-carousel related-carousel owl-loaded owl-drag">
                <div className="owl-stage-outer"><div className="owl-stage" style={{transform: 'translate3d(-1478px, 0px, 0px)', transition: 'all 0s ease 0s', width: '3845px'}}><div className="owl-item cloned" style={{width: '266.75px', marginRight: '29px'}}><div className="card product-item border-0">
