          ...
          <div className="row px-xl-5 pb-3">
            <div className="col-lg-3 col-md-6 col-sm-12 pb-1">
              <div className="d-flex align-items-center border mb-4" style={{padding: '30px'}}>
                ...
                <h5 className="font-weight-semi-bold m-0 ms-2">Quality Product</h5>
              </div>
            </div>
            <div className="col-lg-3 col-md-6 col-sm-12 pb-1">
              <div className="d-flex align-items-center border mb-4" style={{padding: '30px'}}>
                <h1 className="fa fa-shipping-fast text-success m-0 mr-2" />
                <h5 className="font-weight-semi-bold m-0 ms-2">Free Shipping</h5>
              </div>
            </div>
            <div className="col-lg-3 col-md-6 col-sm-12 pb-1">
              <div className="d-flex align-items-center border mb-4" style={{padding: '30px'}}>
                <h1 className="fas fa-exchange-alt text-success m-0 mr-3" />
                <h5 className="font-weight-semi-bold m-0 ms-2">14-Day Return</h5>
              </div>
            </div>
            <div className="col-lg-3 col-md-6 col-sm-12 pb-1">
              <div className="d-flex align-items-center border mb-4" style={{padding: '30px'}}>
                <h1 className="fa fa-phone-volume text-success m-0 mr-3" />
                <h5 className="font-weight-semi-bold m-0 ms-2">24/7 Support</h5>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="col-lg-4 col-md-6 pb-1">
              <div className="cat-item d-flex flex-column border mb-4" style={{padding: '30px'}}>
                ...
                <a href className="cat-img position-relative overflow-hidden mb-3">
                  <img className="img-fluid" src="./images/car2.jpg" alt="" />
                </a>
        ...
        <div className="container-fluid offer pt-5">
          <div className="row px-xl-5">
            <div className="col-md-6 pb-4">
              <div className="position-relative bg-light rounded text-center text-md-right  mb-2 py-5 px-5">
            ...
            <div className="col-md-6 pb-4">
              <div className="position-relative bg-light rounded text-center text-md-left  mb-2 py-5 px-5">
                <img src="./images/car3.jpg" alt="" />
                <div className="position-relative" style={{zIndex: 1}}>
                  <h5 className="text-uppercase text-primary mb-3">20% off the all order</h5>
            ...
            <div className="col-lg-3 col-md-6 col-sm-12 pb-1">
              <div className="card product-item border-0 mb-4">
                <div className="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                  <img className="img-fluid w-100" src="./images/car3.jpg" alt="" />
                </div>
        ...
        <div className="container-fluid bg-secondary my-5">
          <div className="row justify-content-md-center py-5 px-xl-5">
            <div className="col-md-6 col-12 py-5">
              <div className="text-center mb-2 pb-2 text-light">
              ...
              <form action>
                <div className="input-group">
                  ...
                  <div className="input-group-append rounded-end">
                    <button className="btn btn-warning px-4 h-100 rounded-end">Subscribe</button>
                  </div>
                </div>
              </form>
            </div>
